...
type WriterCardTermComponentProps = {};
import { TPTitle, TPContent } from "../SignUp/TermPrivacyComponents";

const WriterCardTermModalComponent: FunctionComponent<
  WriterCardTermComponentProps
> = () => {
  return (
    <WriterCardTermModalComponentContainer>
      <TPTitle>
        아래의 경우가 포함된 경우
        <br />
        이용에 제재가 가해질 수 있습니다.
...
export default WriterCardTermModalComponent;

const WriterCardTermModalComponentContainer = styled.div`
  color: black;
  padding: 20px;
`;
